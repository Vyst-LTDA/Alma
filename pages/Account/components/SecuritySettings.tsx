...
import { changeCurrentUserPassword } from '../../../services/apiService';
...
const SecuritySettings: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.message || "Falha ao alterar a senha. Verifique sua senha atual.");
        } finally {
            setIsSaving(false);
        ...
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="border-t border-gray-200 mt-8 pt-6 flex justify-end items-center gap-4">
                    ...
                    <button type="submit" disabled={isSaving} className="px-6 py-2.5 bg-primary text-white font-semibold rounded-lg hover:bg-primary/90 shadow-sm transition-transform transform hover:scale-105 disabled:bg-gray-400 disabled:cursor-wait">
